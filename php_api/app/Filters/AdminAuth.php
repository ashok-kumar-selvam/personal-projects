...
} else if((isset($user->type) && $user->type != 'admin') && !isset($user->admin_id)) {

return $response->setJson([
'status' => 'reject',
'message' => ' Only admin can access this resource. '])->setStatusCode(ResponseInterface::HTTP_UNAUTHORIZED);
